        ...
        <div className={styles.container}>
          <div className={styles.content}>
            <p className={styles.introText}>
              ...
              전공교육체계도입니다. <br /> <br />
              고려대학교내 43개 학부 또는 학과나 교육과정편람에서 제공하는{" "}
              <br />
              전공 과목의 권장이수학기 및 필수/권장 선이수관계 등을 한눈에 볼 수
              있습니다. <br />
              <br />
              대학과 학과를 선택하면 학과나 교육과정편람에서 제공하는
              전공교육체계도를 탐색가능하고, <br />
              해당 체계도는 그래픽이미지로 다운로드 가능합니다. <br /> <br />
              이 자료는 참고용으로만 사용하고, 보다 자세한 사항은 학부대학
